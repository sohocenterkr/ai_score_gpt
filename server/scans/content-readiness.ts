...
function buildBaseContentReadinessAssessment(
  ...
  return {
    ...
    topics,
    benchmarkNote:
      "800자와 75% 포함 비율은 Site AI Score가 기본 설명량과 렌더링 의존도를 비교하기 위해 사용하는 내부 참고 기준입니다. 모든 검색엔진이나 AI 서비스의 공통 공식 기준은 아닙니다. 핵심 목표는 글자 수 자체가 아니라 AI가 서비스의 정의·대상·이용 절차·요금·환불·고객지원·데이터 처리·FAQ를 정확히 인식하고 실제 고객 질문에 답할 수 있게 하는 것입니다.",
    disclaimer:
...
function ecommerceContentText(value: string): string {
  const replacements: Array<[string, string]> = [
    ...
    ["사용자가 어떤 문제를 해결할 수 있나요?", "제품은 어떤 소재와 제작 특징을 가지고 있나요?"],
    ["어떤 결과물을 얻나요?", "고객은 어떤 제품과 맞춤 제작 옵션을 선택할 수 있나요?"],
    ...
    ["요금, 사용자 자료 처리, 운영 주체와 문의 방법", "상품 가격, 개인정보·주문·결제·배송정보 처리, 운영 주체와 문의 방법"],
    ["관련 링크 단서는 있으나 실제 요금·자료 처리·운영 정보", "관련 링크 단서는 있으나 실제 상품 가격·개인정보·주문·결제·배송정보 처리·운영 정보"],
    ["요금", "상품 가격"],
    ["입력 자료", "주문자·결제·배송정보"],
    ["입력자료", "주문정보"],
    ["추가 비용를", "추가 비용을"],
    ["맞춤 제작 순서을", "맞춤 제작 순서를"],
    ["지원 범위과", "지원 범위와"],
    ["AI가 서비스의 정의·대상·이용 절차·상품 가격", "AI가 브랜드·상품 정의·구매 대상·주문 절차·상품 가격"],
    ["서비스 정의·대상·절차·요금", "브랜드·상품 정의·구매 대상·절차·가격"],
    ["브랜드·상품 정의, 해결하는 문제, 핵심 기능, 고객이 선택할 수 있는 제품과 옵션", "브랜드 정체성, 대표 제품군, 사용 소재, 제작 방식, 선택 가능한 제품·옵션, 품질보증·A/S"],
    ["구매 대상과 상품 선택 상황를", "구매 대상과 상품 선택 상황을"],
    ["제품과 옵션를", "제품과 옵션을"],
    ["주요 이용 대상", "주요 구매 대상"],
    ["실제 활용 상황", "실제 상품 선택 상황"],
    ["준비 정보와 결과물을 확인할 수 있다.", "선택할 옵션과 배송·제작 기간 및 수령 후 지원을 확인할 수 있다."],
    ["실제 서비스 동작과 일치한다.", "실제 판매·주문·배송·A/S 운영과 일치한다."],
    ["상품 가격과 이용 범위", "상품 가격·재고·구매 조건"],
    ["개인정보·자료 처리", "개인정보·주문·결제·배송정보 처리"],
    ["상품 가격과 자료 처리 방식", "상품 가격과 개인정보·주문·결제·배송정보 처리 방식"],
    ["상품 가격제", "상품 가격·재고·구매 조건"],
    ["상품 가격 또는 이용 범위", "상품 가격·재고·구매 조건"],
    ["자료 처리 방식과 정책 링크", "개인정보·주문·결제·배송정보 처리 방식과 정책 링크"],
    ["데이터 처리·FAQ", "개인정보·주문·결제·배송정보 처리·FAQ"],
  ];
