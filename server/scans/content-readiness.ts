...
export function buildContentReadinessAssessment(
  ...
  const topics = [
    make(
      ...
      "서비스 소개를 실제 사용자 화면에 배치하고 핵심 문장은 초기 HTML에도 포함해 주세요.",
      [
    ...
    make(
      ...
      "이용 대상과 활용 사례를 H2 독립 섹션으로 구성하고 관련 상세 페이지를 일반 링크로 연결해 주세요.",
      [
        "주요 이용 대상이 구체적이다.",
    ...
    make(
      ...
      "순서 목록이나 단계형 섹션으로 구현하고 핵심 단계는 초기 HTML에서도 읽히게 해 주세요.",
      [
    ...
    make(
      ...
      "정책·요금·문의 페이지를 일반 링크로 연결하고 화면 안내와 법적 문서가 다르지 않게 해 주세요.",
      [
    ...
    make(
      ...
      "FAQ를 사용자에게 보이는 콘텐츠로 제공하고 도움말·문의 페이지를 설명적 링크로 연결해 주세요.",
      [
        "핵심 질문과 답변이 화면에 있다.",
        "답변이 현재 정책과 일치한다.",
        "도움말·문의 링크가 있다.",
  ...
  return {
    ...
    topics,
    benchmarkNote:
      "800자는 Site AI Score가 기본 설명량을 비교하기 위해 사용하는 내부 참고 기준입니다. 모든 검색엔진이나 AI 서비스의 공통 공식 기준은 아니며, 글자 수보다 정확하고 구체적인 답변 정보가 중요합니다.",
    disclaimer:
