...
function contextualContentInput(
  ...
  const replacements: Array<[string, string]> = [
    ...
    ["사이트 전환 구조에 맞는 거래·문의 정책 단서", "배송·교환·반품·환불·주문제작·A/S 정책 단서"],
    ["사이트 전환 구조에 맞는 결제·예약·문의 정책 정보가 부족합니다.", "배송·교환·반품·환불·주문제작 변경 및 취소·A/S 정책 정보가 부족합니다."],
    ["결제형은 환불·취소·해지, 예약·문의형은 예약 변경·취소 기준, 정보형은 운영 주체와 문의 정책을 명확히 안내하세요.", "배송 방법·기간·배송비, 교환·반품·환불, 주문제작 변경·취소 제한, 불량·오배송 처리와 A/S 기준을 명확히 안내하세요."],
    ["AI가 누구에게 적합한 서비스인지 답하기 위한 이용 대상·활용 사례 정보가 부족합니다.", "AI가 어떤 고객과 구매 목적에 적합한 상품인지 답하기 위한 구매 대상·상품 선택 기준이 부족합니다."],
    ["AI가 어떤 고객에게 적합한 상품인지 답하기 위한 이용 대상·활용 사례 정보가 부족합니다.", "AI가 어떤 고객과 구매 목적에 적합한 상품인지 답하기 위한 구매 대상·상품 선택 기준이 부족합니다."],
    ["이런 분께 추천합니다, 대표 활용 사례, 사용 전후 변화 같은 섹션을 보강하세요.", "추천 고객, 구매 목적, 용도별 상품 선택 기준과 대표 제품군별 추천 대상을 보강하세요."],
    ["대안과의 차이, 대표 사례, 고객 후기, 실적, 사용 예시를 사실 기반으로 보강하세요.", "다른 동종 브랜드·일반 제품과 구분되는 특징, 대표 제품·제작 사례, 소재·등급·공정, 장인·수상·매장·A/S·고객 후기를 검증 가능한 근거와 함께 보강하세요."],
  ];
