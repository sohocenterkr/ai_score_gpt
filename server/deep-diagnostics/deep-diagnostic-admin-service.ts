...
export const SITE_FACT_DEFINITIONS: readonly SiteFactDefinition[] = [
  {
    ...
    label: "브랜드·상품·서비스 정의",
    help: "이 사이트가 실제로 무엇을 제공하는지, 고객이 얻는 핵심 가치가 무엇인지 적습니다. 여기 적은 내용이 나중에 'ChatGPT가 이 서비스를 정확히 설명했는지' 채점하는 정답 기준이 됩니다.",
  ...
  },
  {
    ...
    label: "주요 상품·서비스·기능",
    help: "실제로 제공하는 대표 상품·서비스·핵심 기능을 줄바꿈으로 구분해 적습니다.",
  ...
  },
  {
    key: "target_audience",
    label: "주요 고객·이용 대상",
    help: "누구에게 도움이 되는 서비스인지, 어떤 상황에서 쓰는지 적습니다.",
    placeholder: "예: 현장 사진으로 홍보 글을 작성해야 하는 소상공인",
    important: true,
  },
  {
    key: "usage_steps",
    label: "이용 절차 (구매·예약이 있다면 포함)",
    help: "가입부터 실제 이용까지 순서를 적습니다. 상품 구매나 예약이 있는 사이트라면 그 절차를 적고, 판매·예약 기능이 없는 사이트라면 '판매·예약 없음, 가입 후 바로 이용 가능' 처럼 적어도 됩니다.",
  ...
  },
  {
    ...
    label: "제공 채널과 지원 환경",
    help: "어디서·어떻게 이용할 수 있는지 적습니다(예: 웹·앱, 언어, 지역). 오프라인 매장이나 배송이 없는 온라인 전용 서비스라면 그렇게 적으면 됩니다.",
  ...
  },
  {
    key: "pricing",
    label: "요금·가격 (선택)",
    help: "선택 항목입니다 — 비워두면 이 주제는 채점에서 빠질 뿐, 정밀진단 자체는 그대로 진행됩니다. 완전히 무료라면 '전액 무료로 제공합니다'처럼 적고, 판매하는 상품이 없다면 '판매 상품 없음'이라고 적어도 됩니다.",
  ...
  },
  {
    key: "data_handling",
    label: "개인정보·자료 처리 (선택)",
    help: "선택 항목입니다 — 비워두면 이 주제는 채점에서 빠질 뿐, 정밀진단 자체는 그대로 진행됩니다. 회원가입·업로드 자료가 없다면 '별도로 수집하는 개인정보 없음'이라고 적어도 됩니다.",
  ...
  },
  {
    key: "operator",
    label: "운영 주체 (선택)",
    help: "선택 항목입니다 — 비워두면 이 주제는 채점에서 빠질 뿐, 정밀진단 자체는 그대로 진행됩니다.",
  ...
  },
  {
    ...
    label: "제공하지 않는 것·주의사항 (선택)",
    help: "선택 항목입니다 — 비워두면 이 주제는 채점에서 빠질 뿐, 정밀진단 자체는 그대로 진행됩니다. AI가 과장하거나 잘못 설명하면 안 되는 내용이 있을 때만 적으면 됩니다.",
